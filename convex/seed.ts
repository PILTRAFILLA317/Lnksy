  ...
  handler: async (ctx) => {
    const themes = [
      // ── FREE themes ───────────────────────────────────────
      {
        ...
        name: "Default",
        isPro: false,
        tags: ["light", "minimal", "card", "soft-shadow"],
        config: {
          bg: "#ffffff", text: "#1a1a1a", muted: "#6b7280", accent: "#6366f1",
          cardBg: "#f3f4f6", cardText: "#1a1a1a",
          cardBorder: "transparent", cardRadius: "12px",
          cardShadow: "0 1px 4px rgba(0,0,0,0.06)",
          buttonVariant: "filled", font: "Inter, sans-serif",
          surfaceVariant: "card", linkVariant: "card",
          iconStyle: "mono", density: "comfortable",
      ...
      },
      {
        ...
        name: "Midnight",
        isPro: false,
        tags: ["dark", "minimal", "cool", "card", "no-shadow"],
        config: {
          bg: "#0f172a", text: "#f1f5f9", muted: "#94a3b8", accent: "#818cf8",
      ...
      },
      {
        ...
        name: "Forest",
        isPro: false,
        tags: ["dark", "nature", "warm", "card", "soft-shadow"],
        config: {
          bg: "#064e3b", text: "#ecfdf5", muted: "#6ee7b7", accent: "#34d399",
      ...
      },
      {
        ...
        name: "Slate",
        isPro: false,
        tags: ["light", "cool", "minimal", "card", "soft-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Cream",
        isPro: false,
        tags: ["light", "warm", "minimal", "card", "soft-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Charcoal",
        isPro: false,
        tags: ["dark", "minimal", "card", "no-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Rose",
        isPro: false,
        tags: ["light", "warm", "pastel", "card", "soft-shadow"],
        config: {
      ...
      // ── NEW FREE themes ────────────────────────────────────
      {
        ...
        name: "Sharp",
        isPro: false,
        tags: ["light", "minimal", "sharp", "no-shadow", "flat", "outline", "high-contrast"],
        config: {
          bg: "#ffffff", text: "#000000", muted: "#555555", accent: "#000000",
          cardBg: "transparent", cardText: "#000000",
          cardBorder: "#000000", cardRadius: "0px",
          buttonVariant: "outline", buttonRadius: "0px",
          font: "Inter, sans-serif", shadowIntensity: "none",
          surfaceVariant: "flat", linkVariant: "flat",
          iconStyle: "mono", density: "comfortable",
        },
      },
      {
        ...
        name: "Pill",
        isPro: false,
        tags: ["light", "minimal", "pill", "flat", "no-shadow"],
        config: {
          bg: "#f9fafb", text: "#111827", muted: "#6b7280", accent: "#6366f1",
          cardBg: "#e5e7eb", cardText: "#111827",
      ...
      },
      {
        ...
        name: "Monochrome",
        isPro: false,
        tags: ["light", "minimal", "monochrome", "flat", "no-shadow", "outline"],
        config: {
          bg: "#f5f5f5", text: "#1a1a1a", muted: "#737373", accent: "#404040",
          cardBg: "transparent", cardText: "#1a1a1a",
          cardBorder: "#d4d4d4", cardRadius: "8px",
      ...
      },
      {
        ...
        name: "Ink",
        isPro: false,
        tags: ["dark", "monochrome", "sharp", "no-shadow", "flat", "high-contrast"],
        config: {
          bg: "#0a0a0a", text: "#fafafa", muted: "#a3a3a3", accent: "#fafafa",
          cardBg: "transparent", cardText: "#fafafa",
          cardBorder: "#404040", cardRadius: "4px",
          buttonVariant: "outline", buttonRadius: "4px",
          font: "Inter, sans-serif", shadowIntensity: "none",
          surfaceVariant: "flat", linkVariant: "flat",
          iconStyle: "mono", density: "comfortable",
        },
      ...
      // ── PRO themes — seed.sql originals ───────────────────
      {
        ...
        name: "Sunset",
        isPro: true,
        tags: ["gradient", "warm", "glass", "soft-shadow"],
        config: {
          bg: "linear-gradient(135deg, #f97316, #ec4899)", text: "#ffffff",
          muted: "rgba(255,255,255,0.75)", accent: "#fde68a",
          ...
          backdropBlur: "8px", shadowIntensity: "soft",
          surfaceVariant: "glass", linkVariant: "card",
          iconStyle: "brand", density: "comfortable",
        },
      },
      {
        themeId: "ocean",
        name: "Ocean",
        isPro: true,
        tags: ["gradient", "cool", "glass", "pill", "soft-shadow"],
        config: {
          bg: "linear-gradient(180deg, #0ea5e9, #6366f1)", text: "#ffffff",
          muted: "rgba(255,255,255,0.75)", accent: "#bae6fd",
          cardBg: "rgba(255,255,255,0.12)", cardText: "#ffffff",
          cardBorder: "rgba(255,255,255,0.2)", cardRadius: "999px",
      ...
      },
      {
        ...
        name: "Neon",
        isPro: true,
        tags: ["dark", "neon", "sharp", "outline", "no-shadow", "high-contrast"],
        config: {
          bg: "#09090b", text: "#22d3ee", muted: "#67e8f9", accent: "#22d3ee",
          cardBg: "transparent", cardText: "#22d3ee",
          cardBorder: "#22d3ee", cardRadius: "6px",
          buttonVariant: "outline", buttonRadius: "6px",
          font: "JetBrains Mono, monospace", shadowIntensity: "none",
          surfaceVariant: "flat", linkVariant: "flat",
          iconStyle: "mono", density: "comfortable",
        },
      },
      {
        ...
        name: "Minimal Pro",
        isPro: true,
        tags: ["light", "minimal", "sharp", "outline", "no-shadow", "flat", "business"],
        config: {
          bg: "#fafafa", text: "#171717", muted: "#737373", accent: "#171717",
          cardBg: "transparent", cardText: "#171717",
          cardBorder: "#d4d4d4", cardRadius: "0px",
          buttonVariant: "outline", font: "Inter, sans-serif",
          shadowIntensity: "none",
          surfaceVariant: "flat", linkVariant: "flat",
          iconStyle: "mono", density: "comfortable",
      ...
      },
      {
        ...
        name: "Lavender",
        isPro: true,
        tags: ["pastel", "light", "card", "soft-shadow", "creator"],
        config: {
          bg: "#f5f3ff", text: "#4c1d95", muted: "#7c3aed", accent: "#7c3aed",
          cardBg: "#ede9fe", cardText: "#4c1d95",
          cardBorder: "#c4b5fd", cardRadius: "16px",
          cardShadow: "0 1px 6px rgba(124,58,237,0.08)",
          buttonVariant: "filled", font: "Inter, sans-serif",
          shadowIntensity: "soft",
          surfaceVariant: "card", linkVariant: "card",
          iconStyle: "brand", density: "comfortable",
      ...
      },
      {
        ...
        name: "Brutalist",
        isPro: true,
        tags: ["bold", "brutalist", "warm", "sharp", "no-shadow", "high-contrast", "outline"],
        config: {
          bg: "#fef08a", text: "#000000", muted: "#404040", accent: "#000000",
      ...
      },
      {
        ...
        name: "Glass",
        isPro: true,
        tags: ["glass", "gradient", "cool", "soft-shadow"],
        config: {
          bg: "linear-gradient(135deg, #667eea, #764ba2)", text: "#ffffff",
          muted: "rgba(255,255,255,0.75)", accent: "#c4b5fd",
          ...
          buttonVariant: "filled", font: "Inter, sans-serif",
          backdropBlur: "12px", shadowIntensity: "medium",
          surfaceVariant: "glass", linkVariant: "card",
          iconStyle: "brand", density: "comfortable",
        },
      },
      {
        ...
        name: "Cherry",
        isPro: true,
        tags: ["dark", "warm", "card", "soft-shadow"],
        config: {
          bg: "#1c1917", text: "#fecdd3", muted: "#fda4af", accent: "#fb7185",
      ...
      },
      {
        ...
        name: "Arctic",
        isPro: true,
        tags: ["pastel", "light", "cool", "card", "pill", "soft-shadow"],
        config: {
          bg: "#f0f9ff", text: "#0c4a6e", muted: "#0369a1", accent: "#0ea5e9",
          cardBg: "#e0f2fe", cardText: "#0c4a6e",
          cardBorder: "#7dd3fc", cardRadius: "999px",
          cardShadow: "0 1px 6px rgba(14,165,233,0.1)",
          buttonVariant: "filled", font: "Inter, sans-serif",
          shadowIntensity: "soft",
          surfaceVariant: "card", linkVariant: "card",
          iconStyle: "brand", density: "comfortable",
      ...
      // ── PRO themes — migración 0003 ───────────────────────
      {
        ...
        name: "Aurora",
        isPro: true,
        tags: ["gradient", "cool", "nature", "glass", "card", "soft-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Dusk",
        isPro: true,
        tags: ["gradient", "warm", "glass", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Nebula",
        isPro: true,
        tags: ["gradient", "dark", "cool", "glass", "card", "soft-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Tropical",
        isPro: true,
        tags: ["gradient", "warm", "nature", "glass", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Flamingo",
        isPro: true,
        tags: ["gradient", "warm", "pastel", "glass", "pill", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Citrus",
        isPro: true,
        tags: ["gradient", "bold", "warm", "glass", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Carbon",
        isPro: true,
        tags: ["dark", "minimal", "cool", "sharp", "business"],
        config: {
          ...
          buttonVariant: "outline", buttonRadius: "8px",
          font: "Inter, sans-serif", shadowIntensity: "medium",
          surfaceVariant: "card", linkVariant: "flat",
          iconStyle: "mono", density: "compact",
        },
      },
      {
        themeId: "obsidian",
        name: "Obsidian",
        isPro: true,
        tags: ["dark", "cool", "card", "soft-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Dark Rose",
        isPro: true,
        tags: ["dark", "warm", "pastel", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Void",
        isPro: true,
        tags: ["dark", "minimal", "sharp", "no-shadow", "high-contrast", "monochrome", "business"],
        config: {
      ...
      },
      {
        ...
        name: "Nord",
        isPro: true,
        tags: ["dark", "cool", "minimal", "card", "soft-shadow", "business"],
        config: {
      ...
      },
      {
        ...
        name: "Mocha",
        isPro: true,
        tags: ["dark", "warm", "minimal", "card", "soft-shadow", "business"],
        config: {
      ...
      },
      {
        ...
        name: "Frost",
        isPro: true,
        tags: ["glass", "light", "cool", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Vapor",
        isPro: true,
        tags: ["glass", "gradient", "neon", "cool", "card", "soft-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Crystal",
        isPro: true,
        tags: ["glass", "cool", "gradient", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Butter",
        isPro: true,
        tags: ["pastel", "light", "warm", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Sakura",
        isPro: true,
        tags: ["pastel", "light", "warm", "pill", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Mint",
        isPro: true,
        tags: ["pastel", "light", "cool", "nature", "card", "soft-shadow"],
        config: {
      ...
      },
      {
        ...
        name: "Lilac",
        isPro: true,
        tags: ["pastel", "light", "cool", "card", "soft-shadow", "creator"],
        config: {
      ...
      },
      {
        ...
        name: "Bold Blue",
        isPro: true,
        tags: ["bold", "dark", "cool", "sharp", "high-contrast", "business"],
        config: {
      ...
      },
      {
        ...
        name: "Noire",
        isPro: true,
        tags: ["bold", "dark", "minimal", "sharp", "no-shadow", "high-contrast", "monochrome", "business"],
        config: {
      ...
      },
      {
        ...
        name: "Terracotta",
        isPro: true,
        tags: ["bold", "warm", "nature", "sharp", "high-contrast", "business"],
        config: {
      ...
      },
      {
        ...
        name: "Jungle",
        isPro: true,
        tags: ["bold", "dark", "nature", "warm", "sharp"],
        config: {
      ...
      },
      {
        ...
        name: "Paper",
        isPro: true,
        tags: ["light", "warm", "minimal", "no-shadow", "business"],
        config: {
